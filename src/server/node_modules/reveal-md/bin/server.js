...
var opts = {
    ...
    //template: fs.readFileSync(serverBasePath + '/template/basic_slide_md.html').toString(),
...
var startMarkdownServer = function(basePath, initialMarkdownPath, port, theme, separator, verticalSeparator) {
    ...
    console.log('Reveal-server started, opening at https://localhost:' + opts.port);//------------------ s
    //open('https://localhost:' + opts.port + (initialMarkdownPath ? '/' + initialMarkdownPath : ''));
};
